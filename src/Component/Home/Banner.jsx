  ...
  return (
    <section>
        <div className='container m-auto flex justify-between mt-[117px] font-roboto'>
            ...
            <div className='py-6 px-[91px] bg-black text-white w-fit text-2xl mt-[76px] font-semibold rounded-xl hover:bg-inherit hover:text-black border border-spacing-5 border-black duration-300'>
                <a href="#">Shop now</a>
            </div>
            </div>
            <div className='image'>
